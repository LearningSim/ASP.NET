...
namespace WindowsFormsClient.MyService {
    using System;
    ...
    public partial class MyWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback AverageOperationCompleted;
        ...
        /// <remarks/>
        public MyWebService() {
            this.Url = global::WindowsFormsClient.Properties.Settings.Default.WindowsFormsClient_MyService_MyWebService;
        ...
        /// <remarks/>
        public event AverageCompletedEventHandler AverageCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Average", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public decimal Average(int a, int b) {
            object[] results = this.Invoke("Average", new object[] {
                        a,
                        b});
        ...
        /// <remarks/>
        public void AverageAsync(int a, int b) {
            this.AverageAsync(a, b, null);
        }
        
        /// <remarks/>
        public void AverageAsync(int a, int b, object userState) {
            if ((this.AverageOperationCompleted == null)) {
                this.AverageOperationCompleted = new System.Threading.SendOrPostCallback(this.OnAverageOperationCompleted);
            }
            this.InvokeAsync("Average", new object[] {
                        a,
                        b}, this.AverageOperationCompleted, userState);
        }
        
        private void OnAverageOperationCompleted(object arg) {
            if ((this.AverageCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.AverageCompleted(this, new AverageCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1099.0")]
    public delegate void AverageCompletedEventHandler(object sender, AverageCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1099.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class AverageCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal AverageCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
