                        ...
                        <asp:TemplateField HeaderText="Name" SortExpression="Name">
                            <EditItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                    class="warning" ControlToValidate="TextBox1" Display="Dynamic" 
                                    ErrorMessage="Name required" ForeColor="Red">Name can&#39;t be blank</asp:RequiredFieldValidator>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="PhoneNoFormat" SortExpression="PhoneNoFormat">
                            <EditItemTemplate>
                                <asp:DropDownList ID="DropDownList1" runat="server" 
                                    SelectedValue='<%# Bind("PhoneNoFormat") %>'>
