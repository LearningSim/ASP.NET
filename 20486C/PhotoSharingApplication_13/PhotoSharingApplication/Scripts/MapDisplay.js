...
function GetMap() {
	...
	map = new Microsoft.Maps.Map(document.getElementById("mapDiv"),
		{ credentials: "AviuFLIJ3N98bQ1iDF4_jMsgRVw5r7K8EM0ftfDonoXPYN_dj82tsjhMsjRrkKEr", zoom: 1 });
...
function DisplayPics(response) {
	$.each(response,
		(index, photo) => {
			let location = new Microsoft.Maps.Location(photo.Latitude, photo.Longitude);
